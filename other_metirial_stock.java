 ...
 */
public class other_metirial_stock extends javax.swing.JFrame {
    ...
    /**
     * Creates new form other_metirial_stock
     */
    public other_metirial_stock() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("WM | Other Metirial Stock");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "O m Id", "Item Name", "Item Cost", "Qty"
            }
        ) {
    ...
    private void jTextField3KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField3KeyReleased
        if (Character.isDigit(evt.getKeyChar()) | evt.getKeyCode() == KeyEvent.VK_ENTER
            ...
            if (!jTextField3.getText().equals("") && !jTextField4.getText().equals("")) {
                jTextField5.setText(Double.toString(Double.parseDouble(jTextField3.getText()) * Double.parseDouble(jTextField4.getText())));
            }
        } else {
    ...
    private void jTextField3FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField3FocusGained
        if (jTextField2.getText().equals("")) {
            jTextField2.grabFocus();
            JOptionPane.showMessageDialog(this, "Enter Name for Item !", "ERROR", JOptionPane.INFORMATION_MESSAGE, erricon);
        }
    ...
    private void jTextField4FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField4FocusGained
        if (jTextField3.getText().equals("")) {
            jTextField3.grabFocus();
            JOptionPane.showMessageDialog(this, "Enter Cost for Item !", "ERROR", JOptionPane.INFORMATION_MESSAGE, erricon);
        }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        try {
            ...
            if (jTable1.getSelectedRow() != -1) {
                ...
                Double cost = Double.parseDouble(dtm.getValueAt(jTable1.getSelectedRow(), 2).toString());
                Integer qty = Integer.parseInt(dtm.getValueAt(jTable1.getSelectedRow(), 3).toString());

                jTextField1.setText(id);
                jTextField2.setText(name);
                jTextField3.setText(cost.toString());
                jTextField4.setText(qty.toString());
                jTextField5.setText(Double.toString(cost * qty));
...
// Save
            try {
                ...
                for (int i = 0; i < dtm.getRowCount(); i++) {
                    ...
                    String cost = dtm.getValueAt(i, 2).toString();
                    String qty = dtm.getValueAt(i, 3).toString();

                    DB.iud("insert into o_m_stock (name,cost,qty) "
                            + "values ( '" + name + "','" + cost + "','" + qty + "' )");
                }
            ...
            if (jTextField1.getText().equals("") || jTextField5.getText().equals("")) {
                ...
                if (option == JOptionPane.OK_OPTION) {
                    ...
                    if (password.equals("123")) {
                        DB.iud("update o_m_stock set name = '" + jTextField2.getText() + "', cost = '" + jTextField3.getText() + "', "
                                + "qty = '" + jTextField4.getText() + "' where id = '" + jTextField1.getText() + "' ");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if (jTextField5.getText().equals("")) {
            ...
            if (option == JOptionPane.OK_OPTION) {
                ...
                if (password.equals("123")) {
                    try {
                        DB.iud("delete from o_m_stock where id = '" + jTextField1.getText() + "' ");
...
// Save
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(other_metirial_stock.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new other_metirial_stock().setVisible(true);
            }
        });
    }
    ...
    private void idLoad() {
        try {
            ResultSet rs = DB.search("select id from o_m_stock order by id DESC");
            if (rs.next()) {
    ...
    private void tableLoad() {
        try {
            ...
            DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
            dtm.setRowCount(0);
            ResultSet rs = DB.search("select * from o_m_stock order by id ASC");
            while (rs.next()) {
                Vector<Object> v = new Vector<>();
    ...
    private void tableLoad(String id) {
        try {
            ...
            DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
            dtm.setRowCount(0);
            ResultSet rs = DB.search("select * from o_m_stock where id = '" + id + "' ");
            while (rs.next()) {
                Vector<Object> v = new Vector<>();
                v.add(rs.getString("id"));
                v.add(rs.getString("name"));
