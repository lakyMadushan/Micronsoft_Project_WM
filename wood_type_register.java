 ...
 * @author DELL
 */
public class wood_type_register extends javax.swing.JFrame {
    ...
    public void idload() {
        try {
            ResultSet rs = DB.search("select id from wood_r order by id desc");
            if (rs.next()) {
    ...
    public void tableload() {
        ...
        dtm.setRowCount(0);
        try {
            ResultSet rs = DB.search("select * from wood_r ");
            while (rs.next()) {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("WM | Wood Type Register");
            ...
            if (jTextField2.getText().equals("")) {
                ...
                if (option == JOptionPane.OK_OPTION) {
                    ...
                    if (password.equals("123")) {
                        try {
                            DB.iud("delete from wood_r where id = '" + jTextField1.getText() + "' ");
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if (jTextField2.getText().isEmpty()) {
                ...
                if (option == JOptionPane.OK_OPTION) {
                    ...
                    if (password.equals("123")) {
                        try {
                            DB.iud("update wood_r set wood_t = '" + jTextField2.getText() + "' where id = '" + jTextField1.getText() + "' ");
    ...
    private void jButton1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jButton1KeyPressed
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if (jTextField2.getText().isEmpty()) {
                ...
                try {
                    DB.iud("insert into wood_r (id,wood_t) "
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(wood_type_register.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new wood_type_register().setVisible(true);
            }
        });
    }
