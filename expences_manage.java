 ...
 */
public class expences_manage extends javax.swing.JFrame {
    ...
    /**
     * Creates new form expences_manage
     */
    public expences_manage() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new java.awt.Color(173, 225, 255));

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        jLabel1.setText("WM | Expenses Manager");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "EXP ID", "Reson", "Amount", "Remark", "Date", "Time"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!jTextField4.getText().equals("")) {
            try {
                ...
                DB.iud("insert into expence_manage (date,time,exp_res,amount,remark) "
                        + "values ( '" + jLabel18.getText() + "','" + jLabel19.getText() + "','" + jTextField2.getText() + "','" + jTextField3.getText() + "','" + jTextField4.getText() + "' )");
            ...
            if (jTextField2.getText().equals("") || jTextField3.getText().equals("")) {
                ...
                if (option == JOptionPane.OK_OPTION) {
                    ...
                    if (password.equals("123")) {
                        DB.iud("update expence_manage set exp_res = '" + jTextField2.getText() + "', amount = '" + jTextField3.getText() + "', remark = '" + jTextField4.getText() + "' "
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if (jTextField3.getText().equals("")) {
            ...
            if (option == JOptionPane.OK_OPTION) {
                ...
                if (password.equals("123")) {
                    try {
                        DB.iud("delete from expence_manage where id = '" + jTextField1.getText() + "' ");
    ...
    private void jTextField3FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField3FocusGained
        if (jTextField2.getText().equals("")) {
            jTextField2.grabFocus();
            JOptionPane.showMessageDialog(this, "Please Enter Reson !", "ERROR", JOptionPane.INFORMATION_MESSAGE, erricon);
        }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        try {
            ...
            if (jTable1.getSelectedRow() != -1) {
                ...
                String reson = dtm.getValueAt(jTable1.getSelectedRow(), 1).toString();
                String amount = dtm.getValueAt(jTable1.getSelectedRow(), 2).toString();
                String remark = dtm.getValueAt(jTable1.getSelectedRow(), 3).toString();

                jTextField1.setText(id);
                jTextField2.setText(reson);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(expences_manage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new expences_manage().setVisible(true);
            }
        });
    }
    ...
    private void idLoad() {
        try {
            ResultSet rs = DB.search("select id from expence_manage order by id DESC");
            if (rs.next()) {
    ...
    private void tableLoad() {
        try {
            ...
            Double sum = 0.0;
            if (parts.length >= 2) {
                ResultSet rs = DB.search("select * from expence_manage where date like '" + (parts[0] + "-" + parts[1]) + "%' order by id ASC");

                while (rs.next()) {
                    Vector<Object> v = new Vector<>();
                    v.add(rs.getString("id"));
                    v.add(rs.getString("exp_res"));
    ...
    private void tableLoad(String id) {
        try {
            ...
            String[] parts = jLabel18.getText().toString().split("-");
            if (parts.length >= 2) {
                ResultSet rs = DB.search("select * from expence_manage where id = '" + id + "' and date like '%" + (parts[0] + "-" + parts[1]) + "%' ");
                while (rs.next()) {
                    Vector<Object> v = new Vector<>();
                    v.add(rs.getString("id"));
                    v.add(rs.getString("exp_res"));
