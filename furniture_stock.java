 ...
 * @author DELL
 */
public class furniture_stock extends javax.swing.JFrame {
    ...
    public void idload() {
        try {
            ResultSet rs = DB.search("select id from f_stock order by id desc");
            if (rs.next()) {
                String id = rs.getString("id");
                int id1 = Integer.parseInt(id) + 1;
                jTextField7.setText(String.valueOf(id1));
    ...
    public void Fidload() {
        try {
            ResultSet rs = DB.search("select max(id) as maxid from f_stock");
            if (rs.next()) {
                String id = rs.getString("maxid");
                int id1 = Integer.parseInt(id) + 1;
                jTextField6.setText(String.valueOf("f-" + id1));

            } else {
                jTextField6.setText("f-1");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void tableload() {
        ...
        dtm.setRowCount(0);
        try {
            ResultSet rs = DB.search("select * from f_stock");
            while (rs.next()) {
                ...
                v.add(rs.getString("w_type"));
                v.add(rs.getString("s_price"));
                v.add(rs.getString("qty"));
                v.add(rs.getString("carpenter"));
                v.add(rs.getString("painter"));
                v.add(rs.getString("coshioner"));
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Furniture Name");
        ...
        jLabel6.setText("Furniture Cost Ru.");
        ...
        jLabel19.setText("Carpenter");

        jLabel20.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel20.setText("Sell Price Ru.");

        jLabel21.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel21.setText("Painter");

        jLabel22.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel22.setText("Coshioner");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Furniture ID", "Furniture Name", "Cost", "Wood Type", "Sell Price Ru.", "Qty", "Carpenter", "Painter", "Coshioner"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Integer.class, java.lang.Object.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class
            };
        ...
        jLabel2.setText("WM | Furniture Stock ");
        ...
        jRadioButton1.setText("Furniture ID");
        ...
        jRadioButton2.setText("Furniture Name");
    ...
    private void jTextField11KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField11KeyReleased
        if (Character.isLetter(evt.getKeyChar()) | evt.getKeyCode() == KeyEvent.VK_ENTER | evt.getKeyCode() == KeyEvent.VK_F1
                | evt.getKeyCode() == KeyEvent.VK_BACK_SPACE | evt.getKeyCode() == KeyEvent.VK_DELETE | evt.getKeyCode() == KeyEvent.VK_F2
        ...
        try {
            ...
            if (jRadioButton1.isSelected()) {
                ResultSet rs = DB.search("select * from f_stock where f_id like '%" + jTextField11.getText() + "%'");
                Vector v1 = new Vector();
                while (rs.next()) {
                    v1.add(rs.getString("f_id") + ":" + rs.getString("f_name") + "-" + rs.getString("cost") + "-" + rs.getString("w_type") + "-" + rs.getString("s_price") + "-" + rs.getString("qty") + "-" + rs.getString("carpenter") + "-" + rs.getString("painter") + "-" + rs.getString("coshioner"));
            ...
            if (jRadioButton2.isSelected()) {
                ResultSet rs = DB.search("select * from f_stock where f_name like '%" + jTextField11.getText() + "%'");
                Vector v1 = new Vector();
                while (rs.next()) {
    ...
    private void jList1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jList1MouseClicked
        ...
        jComboBox2.setSelectedItem(prt2[5]);
        jComboBox3.setSelectedItem(prt2[6]);
        jComboBox4.setSelectedItem(prt2[7]);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
        jTextField7.setText(dtm.getValueAt(jTable1.getSelectedRow(), 0).toString());
        jTextField6.setText(dtm.getValueAt(jTable1.getSelectedRow(), 1).toString());
        ...
        jComboBox2.setSelectedItem(dtm.getValueAt(jTable1.getSelectedRow(), 7).toString());
        jComboBox3.setSelectedItem(dtm.getValueAt(jTable1.getSelectedRow(), 8).toString());
        jComboBox4.setSelectedItem(dtm.getValueAt(jTable1.getSelectedRow(), 9).toString());
    ...
    private void jTextField2KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField2KeyReleased
        if (Character.isLetter(evt.getKeyChar()) | evt.getKeyCode() == KeyEvent.VK_ENTER | evt.getKeyCode() == KeyEvent.VK_F1
                ...
                | evt.getKeyCode() == KeyEvent.VK_RIGHT | evt.getKeyCode() == KeyEvent.VK_SPACE) {
            jTextField2.setEditable(true);
        } else {
...
//        }
            ...
            if (option == JOptionPane.OK_OPTION) {
                ...
                if (password.equals("123")) {
                    try {
                        ...
                        DB.iud("update f_stock set f_name = '" + jTextField2.getText() + "'" + ", cost = '" + jTextField3.getText() + "', "
                                + "w_type = '" + jComboBox1.getSelectedItem() + "'" + ", s_price = '" + jTextField4.getText() + "', qty = '" + jTextField5.getText() + "', "
                                + "carpenter = '" + jComboBox2.getSelectedItem() + "'," + " painter = '" + jComboBox3.getSelectedItem() + "',"
                                + " coshioner = '" + jComboBox4.getSelectedItem() + "' where f_id = '" + jTextField6.getText() + "' ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (jTextField2.getText().isEmpty()) {
            ...
            try {
                DB.iud("insert into f_stock (f_id,f_name,cost,w_type,s_price,qty,carpenter,painter,coshioner) "
                        + "values ('" + jTextField6.getText() + "','" + jTextField2.getText() + "','" + "0" + "','" + jComboBox1.getSelectedItem() + "'"
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (jTextField4.getText().equals("")) {
            ...
            if (option == JOptionPane.OK_OPTION) {
                ...
                if (password.equals("123")) {
                    try {
                        DB.iud("delete from f_stock where f_id = '" + jTextField6.getText() + "' ");
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        try {
            ResultSet rs = DB.search("select * from wood_s where wood_t = '" + jComboBox1.getSelectedItem() + "'");
            if (rs.next()) {
                if (rs.getString("wood_t").equals(jComboBox1.getSelectedItem())) {
                    jTextField4.setText(rs.getString("sell_p"));
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
        cost_reason p = new cost_reason();
        p.setVisible(true);
    }//GEN-LAST:event_jMenuItem3ActionPerformed

    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        furniture_costing p = new furniture_costing();
        p.setVisible(true);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        if (jTextField5.getText().equals("")) {
            ...
            furniture_costing_view frame = new furniture_costing_view();
            frame.setVisible(true);

            frame.jTextField2.setText(jTextField6.getText());
            frame.jTextField3.setText(jTextField2.getText());
            frame.jTextField4.setText(jTextField3.getText());
            frame.jTextField5.setText(jTextField7.getText());

            try {
                DefaultTableModel dtm = (DefaultTableModel) frame.jTable2.getModel();
                dtm.setRowCount(0);
                ResultSet rs1 = DB.search("select * from f_costing where f_id = '" + jTextField7.getText() + "'");
                while (rs1.next()) {
                    if (rs1.getString("f_id").equals(jTextField7.getText())) {
                        Vector v = new Vector();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(furniture_stock.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new furniture_stock().setVisible(true);
            }
        });
    }
...
//    
    ...
    private void setWoodType() {
        try {
            jComboBox1.removeAllItems();
            ResultSet rs = DB.search("select * from wood_r order by wood_t");
            while (rs.next()) {
    ...
    private void setCarpenter() {
        try {
            jComboBox2.removeAllItems();
            ResultSet rs = DB.search("select * from emp_r order by emp_id");
            while (rs.next()) {
                jComboBox2.addItem(rs.getString("emp_id"));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void setPainter() {
        try {
            ...
            ResultSet rs = DB.search("select * from emp_r order by emp_id");
            while (rs.next()) {
                jComboBox3.addItem(rs.getString("emp_id"));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void setCoshioner() {
        try {
            jComboBox4.removeAllItems();
            ResultSet rs = DB.search("select * from emp_r order by emp_id");
            while (rs.next()) {
                jComboBox4.addItem(rs.getString("emp_id"));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
