 ...
 */
public class loan_creater extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("WM | Loan Creater");
        ...
        jLabel5.setText("Re Payment Period");

        jLabel6.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel6.setText("Monthly Interest(rate)");
        ...
        jLabel7.setText("Instrolment VAl");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "L Id", "Lender", "Amount", "Pay Peroid", "M Interes", "Ins Val", "Balance", "Remain", "Date", "Time"
            }
        ) {
        ...
        jMenuItem1.setText("Lender Saving");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!jTextField3.getText().equals("")) {
            try {
                ...
                DB.iud("insert into l_create (lender,l_amount,p_period,m_interest,ins_val,balance,remain,date,time) "
                        + "values ( '" + jComboBox1.getSelectedItem() + "','" + jTextField2.getText() + "','" + jTextField3.getText() + "'"
                        + ",'" + jTextField4.getText() + "','" + jTextField5.getText() + "','" + jTextField6.getText() + "','" + jTextField7.getText() + "','" + jLabel18.getText() + "','" + jLabel19.getText() + "' )");
            ...
            if (jTextField2.getText().equals("") || jTextField3.getText().equals("")) {
                ...
                if (option == JOptionPane.OK_OPTION) {
                    ...
                    if (password.equals("123")) {
                        DB.iud("update l_create set l_amount = '" + jTextField2.getText() + "', p_period = '" + jTextField3.getText() + "',"
                                + "m_interest = '" + jTextField4.getText() + "', ins_val = '" + jTextField5.getText() + "',"
                                + "balance = '" + jTextField6.getText() + "', remain = '" + jTextField7.getText() + "' "
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if (jTextField3.getText().equals("")) {
            ...
            if (option == JOptionPane.OK_OPTION) {
                ...
                if (password.equals("123")) {
                    try {
                        DB.iud("delete from l_create where id = '" + jTextField1.getText() + "' ");
    ...
    private void jTextField3FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField3FocusGained
        if (jTextField2.getText().equals("")) {
            ...
            JOptionPane.showMessageDialog(this, " Enter Amount !", "ERROR", JOptionPane.INFORMATION_MESSAGE, erricon);
        }
    ...
    private void jTextField4FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField4FocusGained
        if (jTextField3.getText().equals("")) {
            ...
            JOptionPane.showMessageDialog(this, " Enter Payment Priod !", "ERROR", JOptionPane.INFORMATION_MESSAGE, erricon);
        }
    ...
    private void jTextField4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField4ActionPerformed
        ...
        Double m_interes = p * r / 100;
//        System.err.println(m_interes);
        Double bal = m_interes * n + p;
        Double instrallment = bal / n;

        jTextField5.setText(df.format(instrallment).toString());
        jTextField6.setText(df.format(bal).toString());
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            try {
                ...
                if (jTable1.getSelectedRow() != -1) {
                    ...
                    String lender = dtm.getValueAt(jTable1.getSelectedRow(), 1).toString();
                    String l_amount = dtm.getValueAt(jTable1.getSelectedRow(), 2).toString();
                    String re_pay_p = dtm.getValueAt(jTable1.getSelectedRow(), 3).toString();
                    String rate = dtm.getValueAt(jTable1.getSelectedRow(), 4).toString();
                    String mounth_inst = dtm.getValueAt(jTable1.getSelectedRow(), 5).toString();
                    String bal = dtm.getValueAt(jTable1.getSelectedRow(), 6).toString();
                    String rem = dtm.getValueAt(jTable1.getSelectedRow(), 7).toString();

                    jTextField1.setText(id);
                    jComboBox1.setSelectedItem(lender);
                    jTextField2.setText(l_amount);
                    jTextField3.setText(re_pay_p);
                    jTextField4.setText(rate);
                    jTextField5.setText(mounth_inst);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(loan_creater.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new loan_creater().setVisible(true);
            }
        });
    }
    ...
    private void idLoad() {
        try {
            ResultSet rs = DB.search("select id from l_create order by id DESC");
            if (rs.next()) {
    ...
    private void tableLoad() {
        try {
            ...
            DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
            dtm.setRowCount(0);
            ResultSet rs = DB.search("select * from l_create where balance >= '" + 0.0 + "' order by id ASC");
            while (rs.next()) {
                Vector<Object> v = new Vector<>();
                v.add(rs.getString("id"));
                v.add(rs.getString("lender"));
                v.add(rs.getString("l_amount"));
                v.add(rs.getString("p_period"));
                v.add(rs.getString("m_interest"));
                v.add(rs.getString("ins_val"));
    ...
    private void tableLoad(String id) {
        try {
            ...
            DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
            dtm.setRowCount(0);
            ResultSet rs = DB.search("select * from l_create where id = '" + id + "' ");
            while (rs.next()) {
                Vector<Object> v = new Vector<>();
                v.add(rs.getString("id"));
                v.add(rs.getString("lender"));
    ...
    private void lender_Com() {
        try {
            jComboBox1.removeAllItems();
            ResultSet rs = DB.search("select * from lender order by l_name");
            while (rs.next()) {
                jComboBox1.addItem(rs.getString("l_name"));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
