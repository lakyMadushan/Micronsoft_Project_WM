...
public class employee_register extends javax.swing.JFrame {
    ...
    public void grnIDload() {
        try {
            ...
            ResultSet rs = DB.search("select max(id) as maxid from emp_r");
            if (rs.next()) {
                String id = rs.getString("maxid");
                int id1 = Integer.parseInt(id) + 1;
                jTextField1.setText(String.valueOf("EMP - " + id1));
    ...
    public void tableload() {
        ...
        dtm.setRowCount(0);
        try {
            ResultSet rs = DB.search("select * from emp_r ");
            while (rs.next()) {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Daily Basic", "Feature Basic" }));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "EMP ID", "First Name", "Last Name", "Contact No", "Salary Type", "Amount"
            }
        ) {
        ...
        jLabel2.setText("WM | Employee Register");
        ...
        jLabel10.setText("Employee Search");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(jPanel6, javax.swing.GroupLayout.DEFAULT_SIZE, 1074, Short.MAX_VALUE))))
                .addContainerGap())
        );
    ...
    private void jTextField11KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField11KeyReleased
        try {
            ...
            if (jRadioButton1.isSelected()) {
                ResultSet rs = DB.search("select * from emp_r where p_num like '%" + jTextField11.getText() + "%'");
                Vector v1 = new Vector();
                while (rs.next()) {
                    //if (rs.getString("p_num").equals(jTextField11.getText())) {
                    v1.add(rs.getString("emp_id") + ":" + rs.getString("f_name") + "-" + rs.getString("l_name") + "-" + rs.getString("p_num") + "-" + rs.getString("salary_t") + "-" + rs.getString("amount"));
            ...
            if (jRadioButton2.isSelected()) {
                ResultSet rs = DB.search("select * from emp_r where emp_id like '%" + jTextField11.getText() + "%'");
                Vector v1 = new Vector();
                while (rs.next()) {
                    //if (rs.getString("p_num").equals(jTextField11.getText())) {
                    v1.add(rs.getString("emp_id") + ":" + rs.getString("f_name") + "-" + rs.getString("l_name") + "-" + rs.getString("p_num") + "-" + rs.getString("salary_t") + "-" + rs.getString("amount"));
            ...
            if (jTextField5.getText().equals("")) {
                ...
                if (option == JOptionPane.OK_OPTION) {
                    ...
                    if (password.equals("123")) {
                        try {
                            DB.iud("delete from emp_r where emp_id = '" + jTextField1.getText() + "' ");
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if (jTextField5.getText().isEmpty()) {
                ...
                if (option == JOptionPane.OK_OPTION) {
                    ...
                    if (password.equals("123")) {
                        try {
//                        DB.iud("update emp_r set f_name = '" + jTextField2.getText() + "' where emp_id = '" + jTextField1.getText() + "' ");
//                        DB.iud("update emp_r set l_name = '" + jTextField3.getText() + "' where emp_id = '" + jTextField1.getText() + "' ");
//                        DB.iud("update emp_r set p_num = '" + jTextField4.getText() + "' where emp_id = '" + jTextField1.getText() + "' ");
//                        DB.iud("update emp_r set salary_t = '" + jComboBox1.getSelectedItem() + "' where emp_id = '" + jTextField1.getText() + "' ");
//                        DB.iud("update emp_r set amount = '" + jTextField5.getText() + "' where emp_id = '" + jTextField1.getText() + "' ");

                            DB.iud("update emp_r set f_name = '" + jTextField2.getText() + "', l_name = '" + jTextField3.getText() + "'"
                                    + ", p_num = '" + jTextField4.getText() + "', salary_t = '" + jComboBox1.getSelectedItem() + "'"
                                    + ", amount = '" + jTextField5.getText() + "' where emp_id = '" + jTextField1.getText() + "' ");
    ...
    private void jButton1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jButton1KeyPressed
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if (jTextField5.getText().isEmpty()) {
                ...
                try {
                    ResultSet rs = DB.search("select * from emp_r where p_num = '" + jTextField4.getText() + "'");

                    if (rs.next()) {
                        JOptionPane.showMessageDialog(this, "Already Add This Employee", "DONE!", JOptionPane.INFORMATION_MESSAGE, icon);
                        ...
                        DB.iud("insert into emp_r (emp_id,f_name,l_name,p_num,salary_t,amount) "
