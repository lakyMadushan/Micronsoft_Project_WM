...
public class supplier extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("WM | Supplier REG");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Name", "Contact No", "credit Amount"
            }
        ) {
            ...
            if (jTextField3.getText().equals("")) {
                ...
                if (option == JOptionPane.OK_OPTION) {
                    ...
                    if (password.equals("123")) {
                        try {
                            DB.iud("delete from supplier where id = '" + jTextField1.getText() + "' ");
            ...
            try {
                if (jTextField2.getText().equals("") || jTextField3.getText().equals("")) {
                    ...
                    if (option == JOptionPane.OK_OPTION) {
                        String password = new String(passwordField.getPassword());
                        if (password.equals("123")) {
                            DB.iud("update supplier set name = '" + jTextField2.getText() + "', phone = '" + jTextField3.getText() + "' "
    ...
    private void jButton1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jButton1KeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_LEFT) {
            ...
            if (!jTextField3.getText().equals("")) {
                try {
                    String id = jTextField1.getText();
                    DB.iud("insert into supplier (name,phone,credit_amount) "
                        + "values ( '" + jTextField2.getText() + "','" + jTextField3.getText() + "','" + 0 + "' )");
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            try {
                ...
                if (jTable1.getSelectedRow() != -1) {
                    ...
                    String ca = dtm.getValueAt(jTable1.getSelectedRow(), 3).toString();
    ...
    private void idLoad() {
        try {
            ResultSet rs = DB.search("select id from supplier order by id DESC");
            if (rs.next()) {
    ...
    private void tableLoad() {
        try {
            ...
            DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
            dtm.setRowCount(0);
            ResultSet rs = DB.search("select * from supplier order by id ASC");
            while (rs.next()) {
    ...
    private void tableLoad(String id) {
        try {
            ...
            DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
            dtm.setRowCount(0);
            ResultSet rs = DB.search("select * from supplier where id = '" + id + "' ");
            while (rs.next()) {
                Vector<Object> v = new Vector<>();
                v.add(rs.getString("id"));
                v.add(rs.getString("name"));
