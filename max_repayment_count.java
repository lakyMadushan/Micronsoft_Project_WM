 ...
 * @author DELL
 */
public class max_repayment_count extends javax.swing.JFrame {
    ...
    public void idload() {
        try {
            ResultSet rs = DB.search("select id from m_r_c order by id desc");
            if (rs.next()) {
    ...
    public void tableload() {
        ...
        dtm.setRowCount(0);
        try {
            ResultSet rs = DB.search("select * from m_r_c ");
            while (rs.next()) {

                Vector v = new Vector();
                v.add(rs.getString("id"));
                v.add(rs.getString("month_c"));
                dtm.addRow(v);
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("WM | Max Repayment Count");
            ...
            if (jTextField2.getText().equals("")) {
                ...
                if (option == JOptionPane.OK_OPTION) {
                    ...
                    if (password.equals("123")) {
                        try {
                            DB.iud("delete from m_r_c where id = '" + jTextField1.getText() + "' ");
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if (jTextField2.getText().isEmpty()) {
                ...
                if (option == JOptionPane.OK_OPTION) {
                    ...
                    if (password.equals("123")) {
                        try {
                            DB.iud("update m_r_c set month_c = '" + jTextField2.getText() + "' where id = '" + jTextField1.getText() + "' ");
    ...
    private void jButton1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jButton1KeyPressed
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if (jTextField2.getText().isEmpty()) {
                ...
                try {
                    DB.iud("insert into m_r_c (month_c) "
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(max_repayment_count.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new max_repayment_count().setVisible(true);
            }
        });
    }
